  ...
  return (
    <div className="flex flex-col items-center gap-8 w-full max-w-sm">
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <h1 className="text-2xl font-light tracking-[0.2em] uppercase">Welcome Back</h1>
        <p className="text-sm text-muted-foreground">Sign in to your cosmic journey</p>
      </div>
      ...
      <p className="text-sm text-muted-foreground">
        No account yet?{" "}
        <Link href="/register" className="text-gold hover:text-gold/80 underline underline-offset-4">
          Explore Free
        </Link>
      </p>
    </div>
